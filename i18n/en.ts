...
const en = {
  ...
  tripDetails: {
    ...
    removeFlightTitle: 'Remove flight',
    removeFlightConfirm: 'Are you sure you want to remove this flight?',
    flightDisassociated: 'Flight removed',
  ...
  addTrip: {
    ...
    typeMin2Letters: 'Type at least 2 letters',
